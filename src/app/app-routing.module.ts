...
const routes: Routes = [
  ...
  { path: 'event-plan/:id', component: EventPlanComponent, canActivate: [LoggedGuard]},
  { path: 'event-participation/:id', component: EventParticipationComponent, canActivate: [LoggedGuard]},
  { path: 'event-solicitations/:id', component: EventSolicitationListComponent, canActivate: [AdminGuard]},
